...
@test_approx_eq vnormdiff(x1, y1, Inf, 1) max(abs(x1 - y1), (), 1)
@test_approx_eq vnormdiff(x2, y2, Inf, 1) max(abs(x2 - y2), (), 1)
@test_approx_eq vnormdiff(x2, y2, Inf, 2) max(abs(x2 - y2), (), 2)
@test_approx_eq vnormdiff(x3, y3, Inf, 1) max(abs(x3 - y3), (), 1)
@test_approx_eq vnormdiff(x3, y3, Inf, 2) max(abs(x3 - y3), (), 2)
@test_approx_eq vnormdiff(x3, y3, Inf, 3) max(abs(x3 - y3), (), 3)
